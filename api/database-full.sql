-- Full Database Backup for Portfolio Project
-- Date: 2026-02-27
-- Database: projects
...
CREATE DATABASE IF NOT EXISTS `projects` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `projects`;
...
/*!40000 ALTER TABLE `feature_boxes` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `feature_boxes` ENABLE KEYS */;
